__includes ["Network.nls" "RK4-Metapop.nls"]
...
to setup
  ...
  reset-ticks
  infect-one-guy
  set TotalPop NB_nodes * Population-on-nodes
end

;make sure colors of nodes and edges are visible on a black background
to define-colors
...
329
798
At initialization step, one infected person is randomly allocated to one node
12
0.0
1
